...
public class FlashCardGUI extends Application {
    ...
    public void createLeft(){
    	...
    	addCatButton.setOnAction(e->{
    		try {
				Category myCategory=new Category(addCatTextField.getCharacters().toString());
				catArray.add(myCategory);
			} catch (Exception e1) {
    ...
    public void createRight(){
        ...
        ListView<Category> catList=new ListView<Category>();
        catList.setMaxWidth(170);
        catList.getItems().addAll(catArray);
